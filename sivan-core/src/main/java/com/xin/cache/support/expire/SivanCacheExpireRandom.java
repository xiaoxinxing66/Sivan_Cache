 ...
 * @param <V> value
 */
public class SivanCacheExpireRandom<K,V> implements ISivanCacheExpire<K,V> {

    private static final Log log = LogFactory.getLog(SivanCacheExpireRandom.class);
    ...
    public SivanCacheExpireRandom(ISivanCache<K, V> cache) {
        this.cache = cache;
        this.init();
    }
    ...
    private K getRandomKey2() {
        ...
        // 正常逻辑不会到这里
        throw new SivanCacheRuntimeException("对应信息不存在");
    }
